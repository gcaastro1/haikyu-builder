...
import { saveStatsBond } from "../actions/saveStatsBond";

interface StatsBondCreationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: (newStatsBond: StatsBondType) => void;
}

export function StatsBondCreationModal({ isOpen, onClose, onSuccess }: StatsBondCreationModalProps) {
